...
function dons_files() {
  ...
  wp_enqueue_style('google_fonts', '//fonts.googleapis.com/css?family=EB+Garamond|Bilbo+Swash+Caps|Kaushan+Script|Merienda+One|Muli:400,600,700,800" rel="stylesheet">');
